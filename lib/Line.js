  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      lines.map(function (dataKey, index) {
        return _react2.default.createElement(_recharts.Line, { isAnimationActive: false, type: 'monotone', key: dataKey, dataKey: dataKey, stroke: colors[index % colors.length] });
      })
    )
  );
};
